...
from instrument_drivers import LeidenCryogenics_TripleCurrentSource, LeidenCryogenics_GHS_2T_1T_700_CF, Picowatt_AVS47B

# Set the addresses for the instruments
resistance_bridge_address = ''
ghs_address = ''
tcs_address = ''
...
def setup_instruments():
    ...
    resistance_bridge = Picowatt_AVS47B.Avs_47b('resistance_bridge', resistance_bridge_address)
